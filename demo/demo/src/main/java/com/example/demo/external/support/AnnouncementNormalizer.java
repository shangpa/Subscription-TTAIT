package com.example.demo.external.support;
...
public class AnnouncementNormalizer {
    ...
    public String normalizeSupplyType(String raw) {
        ...
        if (raw.contains("신혼희망타운")) {
            return "신혼희망타운";
        }
        if (raw.contains("국민임대")) {
            return "국민임대";
        }
        if (raw.contains("행복주택")) {
            return "행복주택";
        }
        if (raw.contains("영구임대")) {
            return "영구임대";
        }
        if (raw.contains("매입임대")) {
            return "매입임대";
        }
        if (raw.contains("전세임대")) {
            return "전세임대";
        }
        if (raw.contains("공공분양") || raw.contains("분양")) {
            return "공공분양";
        }
        return "기타";
    }
    ...
    public String normalizeHouseType(String raw) {
        ...
        if (raw.contains("다세대") || raw.contains("연립") || raw.contains("빌라")) {
            return "다세대/연립";
        }
        if (raw.contains("오피스텔")) {
            return "오피스텔";
        }
        return "기타";
    }
    ...
    public String normalizeProviderName(String raw, String fallback) {
        ...
        if (normalized.contains("LH") || normalized.contains("한국토지주택공사")) {
            return "LH";
        }
        if (normalized.contains("SH") || normalized.contains("서울주택도시공사")) {
            return "SH";
        }
        if (normalized.contains("GH") || normalized.contains("경기주택도시공사")) {
            return "GH";
        }
        return value;
    }
    ...
    public AnnouncementStatus calculateStatus(LocalDate startDate, LocalDate endDate, String rawStatus) {
        ...
        if (rawStatus != null && (rawStatus.contains("공고중") || rawStatus.contains("모집중"))) {
            return AnnouncementStatus.OPEN;
        }
        return AnnouncementStatus.SCHEDULED;
    }
